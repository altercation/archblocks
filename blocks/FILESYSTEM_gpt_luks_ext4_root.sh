...
/dev/disk/by-partlabel/${LABEL_BOOT_EFI}		$EFI_BOOT_PATH	vfat	rw,relatime,discard,fmask=0022,dmask=0022,codepage=cp437,iocharset=iso8859-1,shortname=mixed,errors=remount-ro	0 2
